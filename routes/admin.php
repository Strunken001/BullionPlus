...
use App\Http\Controllers\Admin\BundleLogsController;
...
use App\Http\Controllers\Admin\QuickRechargeController;
use App\Http\Controllers\Admin\QuickTopupController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // Data Bundle Logs
    Route::controller(BundleLogsController::class)->prefix('data-bundle')->name('data.bundle.')->group(function () {
        //logs
        Route::get('index', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
    });
    ...
    Route::controller(UserCareController::class)->prefix('users')->name('users.')->group(function () {
        ...
        Route::get('phone/unverified', 'phoneUnverified')->name('phone.unverified');
    ...
    Route::controller(QuickRechargeController::class)->prefix('quick')->name('quick.recharge.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
        Route::put('update', 'update')->name('update');
        Route::delete('delete', 'delete')->name('delete');
    ...
    // Quick Topup Section
    Route::controller(QuickTopupController::class)->prefix('short')->name('short.topup.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
        Route::put('update', 'update')->name('update');
        Route::delete('delete', 'delete')->name('delete');
