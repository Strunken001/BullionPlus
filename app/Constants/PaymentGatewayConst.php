    ...
    public static function registerRedirection()
    {
        return [
            'web'       => [
                ...
                'cancel_url'    => 'user.recharge.payment.cancel',
                'callback_url'  => 'user.recharge.payment.callback',
                'redirect_form' => 'user.recharge.payment.redirect.form',
                'btn_pay'       => 'user.recharge.payment.btn.pay',
            ],
            'api'       => [
