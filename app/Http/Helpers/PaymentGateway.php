...
class PaymentGateway
{
    ...
    public function gateway()
    {
        ...
        $this->output['invoice']            = $this->request_data['invoice'] ?? null;
    ...
    {
        $output['invoice'] = $output['tempData']['invoice'] ?? null;
    ...
    public function insertCharges($output, $id)
    {
        ...
        try {
            DB::table('transaction_charges')->insert([
                'transaction_id'    => $id,
                'percent_charge'    => $output['amount']->percent_charge / $output['amount']->exchange_rate,
                'fixed_charge'      => $output['amount']->fixed_charge / $output['amount']->exchange_rate,
                'total_charge'      => $output['amount']->total_charge / $output['amount']->exchange_rate,
                'created_at'        => now(),
            ]);
            DB::commit();
        } catch (Exception $e) {
