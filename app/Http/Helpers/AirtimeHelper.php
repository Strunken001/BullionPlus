...
class AirtimeHelper
{
    ...
    //  * Payment Utility Bill
    //  */
    // public function makePromotion($size,$lang)
    // {
    //     if(!$this->access_token) $this->accessToken();

    //     $base_url = $this->config['request_url'];
    //     $endpoint = $base_url . "/promotions"."?size=$size&page=1&"."languageCode=$lang";
    //     // $endpoint = $base_url . "/promotions/country-codes/".$lang."?languageCode=EN";
