...
class GiftCardController extends Controller
{
    ...
    public function insertCardBuy($trx_id, $user, $userWallet, $charges, $giftCard, $status, $qty)
    {
        ...
        try {
            $id = DB::table("transactions")->insertGetId([
                ...
                'trx_id'                        => $trx_id,
                'request_amount'                => $charges['card_unit_price'] * $qty,
                ...
                'receive_amount'                => $charges['conversion_amount'],
                'receiver_type'                 => null,
                'receiver_id'                   => null,
    ...
    /**
     * Retrieves the balance of the user's wallet for the specified currency.
     *
    ...
    public function balance(Request $request)
    {
        ...
        try {
            // Fetch the user's wallet for the specified currency
