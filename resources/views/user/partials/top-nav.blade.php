                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <div class="d-flex align-items-center ms-auto gap-2">
                            <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="collapse"
                             ...
                             @if (Auth::check())
                                <div class="header-action dashboard-dropdown-btn d-lg-none">
                                    @if (auth()->user()->image)
                                    ...
                                    <div class="dropdown-btn-list">
                                        <ul class="dropdown-list-item">
                                            ...
                                            <li>
                                                <div class="title-area">
                                                    <a
                                                        href="{{ setRoute('user.profile.index') }}">{{ __('My Profile') }}</a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="title-area">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <select class="form--control nice-select" name="lang_switcher">
                                        @foreach ($__languages as $item)
                                            <option value="{{ $item->code }}"
                                                @if ($session_lan == $item->code) @selected(true) @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            @if (Auth::check())
                                <div class="header-action dashboard-dropdown-btn d-none d-lg-block">
                                    @if (auth()->user()->image)
                                        <a href="javascript:void(0);" class="profile-action-btn">
                                            <img src="{{ get_image(auth()->user()->image, 'user-profile') }}"
                                                alt="img">
    ...
    <script>
        ...
        document.querySelectorAll('.profile-action-btn').forEach(function(btn) {
            btn.addEventListener('click', function() {
                const dropdown = document.querySelector('.dropdown-btn-list');
