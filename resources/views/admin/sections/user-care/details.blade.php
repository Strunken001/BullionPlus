                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ get_amount($user->wallets->balance, get_default_currency_code()) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $transactionsAll }}</h2>
                                </div>
                            </div>
                            <div class="right">
                            </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $allTicket }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __('Active') }} {{ $allTicket }}</span>
                                    <span class="badge badge--success">{{ __('Solved') }} {{ $completeTicket }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart9"
                                    data-percent="@if ($allTicket === 0) 0 @else {{ ($completeTicket / $allTicket) * 100 }} @endif">
                                    <span>
                                        @if ($allTicket === 0)
                                            0
                                        @else
                                            {{ ($completeTicket / $allTicket) * 100 }}
                                        @endif
                                    </span>
                                </div>
                            </div>
