        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#faq-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>{{ textLength($item->language->$system_default_lang->answer ?? "", 50) }}</td>
                                <td>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                editModal.find("textarea[name="+item.code+"_question_edit]").val(oldData.language[item.code]?.question);
