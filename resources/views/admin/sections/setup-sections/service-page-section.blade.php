                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>{{ textLength($item->language->$system_default_lang->description ?? "", 50) }}</td>
                                <td>{{ Str::limit($item->link ?? "", 25, '...') ?? "" }}</td>
                                <td>
...
@push('script')
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            fileHolderPreviewReInit("#service-page-item-edit input[name=image_edit]");
