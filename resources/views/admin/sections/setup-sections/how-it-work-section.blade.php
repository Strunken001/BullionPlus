...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#how-it-works-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-how-it-works-item')

    {{-- How it works edit modal --}}
    <div id="how-it-works-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("how-it-works-item-add","#how-it-works-item-add");
        openModalWhenError("how-it-works-item-edit","#how-it-works-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#how-it-works-item-edit");
            ...
            openModalBySelector("#how-it-works-item-edit");
