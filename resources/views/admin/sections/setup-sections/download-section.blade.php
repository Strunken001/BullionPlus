...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#download-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                <td></td>
                                <td>
                                    {{ $item->language->$system_default_lang->title ?? '' }}
                                </td>
                                <td>{{ $item->link ?? '' }}
                                </td>
    ...
    @include('admin.components.modals.site-section.add-download-item')

    {{-- Download edit modal --}}
    <div id="download-item-edit" class="mfp-hide large">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="form-group">
                                    @include('admin.components.form.input', [
                                        ...
                                        'placeholder' => __('Write Here') . '...',
                                        'name' => 'link_edit',
                                        'value' => old('link_edit',$data->value->link ?? ''),
                                    ])
                                </div>
                                <div class="form-group">
                                    @include('admin.components.form.input', [
...
@push('script')
    ...
    <script>
        openModalWhenError("download-item-add", "#download-item-add");
        openModalWhenError("download-item-edit", "#download-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#download-item-edit");
            ...
            openModalBySelector("#download-item-edit");
