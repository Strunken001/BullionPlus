<table class="custom-table transaction-search-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ get_amount($item->total_charge,$item->details->charge_info->wallet_currency)}}</td>
            <td>{{ get_amount($item->total_payable,$item->details->charge_info->wallet_currency)}}</td>
